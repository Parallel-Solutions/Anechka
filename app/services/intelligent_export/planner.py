...
- Название стадии (Новая, Тёплый, Архив, длинные kanban-имена) резолвится сервером по справочнику всех воронок (БД + Bitrix API).
...
- В assistant_message укажи, что контакт/телефон выбираются серверной эвристикой,
